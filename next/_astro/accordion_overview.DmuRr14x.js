...
import{_ as t}from"./preload-helper.nLWefGx3.js";import{S as r,L as s}from"./node-tools_providence-analytics_overview.LFFQBZzG.js";import{i as a}from"./lit-element.qDHKJJma.js";import{x as n}from"./lit-html.C7L4dwLU.js";import"./unsafe-html.J0GGe2Q7.js";import"./directive.CGE4aKEl.js";class d extends r(a){static get scopedElements(){return{"lion-accordion":s}}render(){return n`
      <lion-accordion>
        <h3 slot="invoker">
    ...
    `}}customElements.define("my-component",d);const l=()=>n`<my-component></my-component>`,m=document,c=[{key:"overview",story:l}];let i=!1;for(const e of c){const o=m.querySelector(`[mdjs-story-name="${e.key}"]`);o&&(o.story=e.story,o.key=e.key,i=!0,Object.assign(o,{simulatorUrl:"/lion/next/simulator/",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}i&&(customElements.get("mdjs-preview")||t(()=>import("./define.DYUong5B.js"),__vite__mapDeps([0,1,2,3,4,5])),customElements.get("mdjs-story")||t(()=>import("./define.m2CvvXyF.js"),__vite__mapDeps([6,2,3])));export{l as overview};
