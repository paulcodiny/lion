...
import{_ as c}from"./preload-helper.nLWefGx3.js";import{L as u}from"./node-tools_providence-analytics_overview.LFFQBZzG.js";import{i as m}from"./lit-element.qDHKJJma.js";import{x as t}from"./lit-html.C7L4dwLU.js";import"./unsafe-html.J0GGe2Q7.js";import"./directive.CGE4aKEl.js";customElements.define("lion-accordion",u);const p=()=>t`<lion-accordion>
  <h3 slot="invoker">
...
</lion-accordion>`,v=()=>t`<lion-accordion expanded="[1]">
  <h3 slot="invoker">
    <button>Sensory Factors</button>
  </h3>
  <div slot="content">
...
</lion-accordion>`,g=()=>t`<lion-accordion>
  <h3 slot="invoker">
    <button>Sensory Factors</button>
  </h3>
  <h3 slot="invoker">
...
</lion-accordion>`,y=()=>t`<lion-accordion>
  <h3 slot="invoker">
    <button>
      Sensory Factors <br />
...
</lion-accordion>`,b=()=>t`<lion-accordion exclusive>
  <h3 slot="invoker">
  ...
  <div slot="content">
    ...
    amounts (table).
...
</lion-accordion>`,f=()=>{class o extends m{static get properties(){return{__collection:{type:Array}}}render(){return t`
        <h3>Append</h3>
        ...
        <lion-accordion id="pushTabs">
          ...
          <p slot="content">content 2</p>
          ${this.__collection.map(e=>t`
              <h4 slot="invoker"><button>${e.invoker}</button></h4>
              <p slot="content">${e.content}</p>
            `)}
        </lion-accordion>
        <button @click="${this.__handlePushClick}">Push to tabs collection</button>
      `}constructor(){super(),this.__collection=[]}__handleAppendClick(){const e=this.shadowRoot.querySelector("#appendAccordion"),i=2,l=Math.floor(e.children.length/2);for(let r=l+1;r<l+i;r+=1){const a=document.createElement("h4"),d=document.createElement("button");d.innerText=`header ${r}`,a.setAttribute("slot","invoker"),a.appendChild(d);const s=document.createElement("p");s.setAttribute("slot","content"),s.innerText=`content ${r}`,e.append(a),e.append(s)}}__handlePushClick(){const e=this.shadowRoot.querySelector("#pushTabs"),i=Math.floor(e.children.length/2)+1;this.__collection=[...this.__collection,{invoker:`header ${i}`,content:`content ${i}`}]}}return customElements.define("demo-distribute",o),t`<demo-distribute></demo-distribute>`},k=document,w=[{key:"HtmlStory0",story:p},{key:"HtmlStory1",story:v},{key:"HtmlStory2",story:g},{key:"HtmlStory3",story:y},{key:"HtmlStory4",story:b},{key:"distributeNewElement",story:f}];let h=!1;for(const o of w){const n=k.querySelector(`[mdjs-story-name="${o.key}"]`);n&&(n.story=o.story,n.key=o.key,h=!0,Object.assign(n,{simulatorUrl:"/lion/next/simulator/",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}h&&(customElements.get("mdjs-preview")||c(()=>import("./define.DYUong5B.js"),__vite__mapDeps([0,1,2,3,4,5])),customElements.get("mdjs-story")||c(()=>import("./define.m2CvvXyF.js"),__vite__mapDeps([6,2,3])));export{p as HtmlStory0,v as HtmlStory1,g as HtmlStory2,y as HtmlStory3,b as HtmlStory4,f as distributeNewElement};
