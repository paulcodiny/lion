...
import{_ as c}from"./preload-helper.nLWefGx3.js";import"./node-tools_providence-analytics_overview.LFFQBZzG.js";import{a as n,i as f}from"./lit-element.qDHKJJma.js";import{x as o}from"./lit-html.C7L4dwLU.js";import"./unsafe-html.J0GGe2Q7.js";import{L as a}from"./LionOption.BBDF9KmV.js";import{L as l}from"./LionCombobox.DXYgCoPB.js";import{L as b}from"./LionButton.B9nVXwmc.js";import{r as s}from"./renderLitAsNode.DRxcIGFy.js";import"./directive.CGE4aKEl.js";import"./InteractionStateMixin.C2Xjq1f8.js";import"./dedupeMixin.6XPTJgK8.js";import"./LocalizeMixin.VYu75dkK.js";import"./directive-helpers.CLllgGgm.js";import"./async-directive.CHVe8p0E.js";import"./getLocalizeManager.W5d_ICRU.js";import"./index.BNCfcFQh.js";import"./lazifyInstantiation.CgYLRMC3.js";import"./DisabledMixin.Bm1nsErI.js";import"./ChoiceGroupMixin.D4jczhm9.js";import"./FormRegistrarMixin.DBLbGJl3.js";import"./ChoiceInputMixin.CLlllJmN.js";import"./OverlayMixin.Clz3oycz.js";import"./withDropdownConfig.eRP55go6.js";import"./withClickInteraction.B1DPetIk.js";import"./validators.Dx-g-RY2.js";import"./Validator.DAOhFpDH.js";import"./DisabledWithTabIndexMixin.DiSGvuwH.js";const d=new WeakMap;function x(i,e){let t=e;for(;t;){if(d.get(t)===i)return!0;t=Object.getPrototypeOf(t)}return!1}function h(i){return e=>{if(x(i,e))return e;const t=i(e);return d.set(t,i),t}}const _=h(i=>class extends i{static get styles(){return[...super.styles,n`
          ...
          `]}_groupOneTemplate(){return o``}_inputGroupInputTemplate(){return o`
          <div class="input-group__input">
            ${this._labelTemplate()}
            <slot name="input"></slot>
          </div>
        `}_inputGroupTemplate(){return o`
        ...
        `}});class w extends f{static get styles(){return[n`
        :host {
          overflow: hidden;
      ...
      `]}render(){return o` <div id="ripple"></div> `}firstUpdated(e){super.firstUpdated(e),this._ripple=this.shadowRoot.querySelector("#ripple"),this._ripple.style.cssText=`width: ${this.offsetHeight}px; height: ${this.offsetHeight}px;`,this.__onRipple=this.__onRipple.bind(this),this.addEventListener("mousedown",this.__onRipple)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("mousedown",this.__onRipple)}__onRipple(e){this._ripple.classList.remove("animate");const t=this.getBoundingClientRect(),r={top:t.top+document.body.scrollTop,left:t.left+document.body.scrollLeft};this._ripple.style.left=`${parseInt(e.pageX-r.left,10)-this._ripple.offsetWidth/2}px`,this._ripple.style.top=`${parseInt(e.pageY-r.top,10)-this._ripple.offsetHeight/2}px`,this._ripple.classList.add("animate")}}customElements.define("md-ripple",w);const p=document.createElement("link");p.href="https://fonts.googleapis.com/css?family=Roboto:300,400,500";p.rel="stylesheet";p.type="text/css";document.head.appendChild(p);class v extends a{static styles=[...super.styles,n`
      :host {
        position: relative;
        padding: 8px;
      }
    ...
    `];onFilterMatch(e){const{innerHTML:t}=this;this.__originalInnerHTML=t,this.innerHTML=t.replace(new RegExp(`(${e})`,"i"),'<span class="md-highlight">$1</span>'),this.style.display=""}onFilterUnmatch(){this.__originalInnerHTML&&(this.innerHTML=this.__originalInnerHTML),this.style.display="none"}render(){return o`
      ${super.render()}
      <md-ripple></md-ripple>
    `}}customElements.define("md-option",v);class y extends _(l){static styles=[...super.styles,n`
      .input-group__container {
        display: flex;
        border-bottom: none;
      }
    ...
    `];constructor(){super(),this.showAllOnEmpty=!0}}customElements.define("md-combobox",y);class k extends b{static get properties(){return{value:String}}static get styles(){return n`
      :host {
        outline: none;
        position: relative;
        display: inline-flex;
    ...
    `}render(){return o` <slot name="before"></slot>
      ${this.value}
      <slot name="after"></slot>
      <slot name="_button"></slot>`}}customElements.define("gh-button",k);class $ extends a{static get properties(){return{category:String,default:{type:Boolean,reflect:!0}}}static get styles(){return[...super.styles,n`
        :host {
          display: flex;
          align-items: center;
          width: 100%;
    ...
    `}}customElements.define("gh-option",$);class T extends l{static get properties(){return{category:{type:String},isDesktop:{type:Boolean,reflect:!0,attribute:"is-desktop"}}}static get styles(){return[...super.styles,n`
    ...
    `}get _comboboxNode(){if(this.__comboboxNode)return this.__comboboxNode;const e=this.querySelector('[slot="input"]');if(e)return this.__comboboxNode=e,e;const t=this._overlayCtrl?.contentWrapperNode.querySelector('[slot="input"]');return t?(this.__comboboxNode=t,t):null}_inputGroupInputTemplate(){return o`
      <div class="input-group__input">
        <slot name="input"></slot>
      </div>
    `}_groupTwoTemplate(){return o` ${this._inputGroupTemplate()} ${this._feedbackTemplate()} `}get slots(){return{...super.slots,"selection-display":()=>s(o`
          <gh-button>
            <svg
              slot="before"
              text="gray"
        ...
        `)}}get _overlayInvokerNode(){return this.querySelector('[slot="selection-display"]')}get _overlayReferenceNode(){return this._overlayInvokerNode}get _categoryButtons(){return Array.from(this.shadowRoot.querySelectorAll(".gh-categories__btn[data-category]"))}constructor(){super(),this.showAllOnEmpty=!0,this.category="branches",this.selectionFollowsFocus=!1,this.__mobileDropdownComboConfig=this.config}firstUpdated(e){super.firstUpdated(e);const t=window.matchMedia("(min-width: 544px)");this.isDesktop=t.matches,t.addListener(({matches:r})=>{this.isDesktop=r})}updated(e){if(super.updated(e),e.has("category")){const t=this.category;this._categoryButtons.forEach(r=>{r.setAttribute("aria-pressed",r.getAttribute("data-category")===t?"true":"false")}),this._inputNode.placeholder=t==="branches"?"Find or create a branch...":"Find a tag",this._handleAutocompletion()}e.has("opened")&&(this._selectionDisplayNode.value=this.modelValue||"Choose a value...",this.opened?setTimeout(()=>{this._inputNode.focus()}):setTimeout(()=>{this._selectionDisplayNode.focus()},100)),e.has("isDesktop")}__handleCategory(e){this.category=e.target.getAttribute("data-category")}_textboxOnKeydown(){this.__hasSelection=this._inputNode.value.length!==this._inputNode.selectionStart}_setupOpenCloseListeners(){super._setupOpenCloseListeners(),this.__toggleOverlay=this.__toggleOverlay.bind(this),this._overlayInvokerNode.addEventListener("click",this.__toggleOverlay)}__toggleOverlay(){this.opened=!this.opened}_teardownOpenCloseListeners(){super._teardownOpenCloseListeners(),this._overlayInvokerNode.removeEventListener("click",this.__toggleOverlay)}}customElements.define("gh-combobox",T);class L extends a{static get properties(){return{title:String,text:String,time:String,image:String,isUserText:{attribute:"is-user-text",reflect:!0,type:Boolean},isUserTextRead:{attribute:"is-user-text-read",reflect:!0,type:Boolean}}}static styles=[...super.styles,n`
      :host {
    ...
    `];render(){return o`<div class="wa-option">
      <div class="wa-option__image">
        <div class="wa-option__image-inner">
          ...
          />
          ${this.image?"":o`<div class="wa-option__image-inner-inner">
    ...
    </div>`}onFilterMatch(e){this.__originalTitle=this.title;const t=this.title.replace(new RegExp(`(${e})`,"i"),"<b>$1</b>"),r=document.createElement("div");r.innerHTML=`<span aria-label="${this.title}">${t}</span>`,[this.title]=r.children,this.style.cssText=`
    max-height: 500px;
    opacity: 1;
    `}onFilterUnmatch(){this.__originalTitle&&(this.title=this.__originalTitle),this.style.cssText=`
    max-height: 0;
    opacity: 0;
    `}}customElements.define("wa-option",L);class z extends l{static styles=[...super.styles,n`
      :host {
        font-family:
          SF Pro Text,
          SF Pro Icons,
    ...
    `];get slots(){return{...super.slots,prefix:()=>s(o`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
            <path
              fill="currentColor"
              d="M15.009 13.805h-.636l-.22-.219a5.184 5.184 0 0 0 1.256-3.386 5.207 5.207 0 1 0-5.207 5.208 5.183 5.183 0 0 0 3.385-1.255l.221.22v.635l4.004 3.999 1.194-1.195-3.997-4.007zm-4.808 0a3.605 3.605 0 1 1 0-7.21 3.605 3.605 0 0 1 0 7.21z"
            ></path>
          </svg>`)}}constructor(){super(),this.opened=!0,this.showAllOnEmpty=!1,this.rotateKeyboardNavigation=!1}}customElements.define("wa-combobox",z);const M=i=>class extends i{static get properties(){return{href:String,target:String}}constructor(){super(),this._nativeAnchor=document.createElement("a")}connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","link")}firstUpdated(e){super.firstUpdated(e),this.addEventListener("click",this.__navigate),this.addEventListener("keydown",({key:t})=>{(t===" "||t==="Enter")&&this.__navigate()})}updated(e){super.updated(e),e.has("href")&&(this._nativeAnchor.href=this.href),e.has("target")&&(this._nativeAnchor.target=this.target)}__navigate(){this._nativeAnchor.click()}},S=h(M),g=o`
...
`,A=new URL("/lion/next/_astro/googlelogo_color_272x92dp.CUA6EDD2.png",import.meta.url).href;class B extends S(a){static get properties(){return{imageUrl:{type:String}}}static get styles(){return[...super.styles,n`
        :host {
          position: relative;
          padding: 8px 16px;
          display: flex;
      ...
      `]}onFilterMatch(e){const{innerHTML:t}=this;this.__originalInnerHTML=t;const r=t.replace(new RegExp(`(${e})`,"i"),'<span class="google-option__highlight">$1</span>');this.setAttribute("aria-label",this.textContent),this.innerHTML=r,this.style.display=""}onFilterUnmatch(){this.removeAttribute("aria-label"),this.__originalInnerHTML&&(this.innerHTML=this.__originalInnerHTML),this.style.display="none"}render(){return o`
      ${this.imageUrl?o` <img class="google-option__icon" src="${this.imageUrl}" alt="" />`:o` <div class="google-option__icon">${g}</div>`}
      ${super.render()}
    `}}customElements.define("google-option",B);class I extends l{static get styles(){return[...super.styles,n`
        /** @configure FormControlMixin */
      ...
      `]}_overlayListboxTemplate(){return o`
      ...
      <slot id="options-outlet"></slot>
    `}_inputGroupSuffixTemplate(){return o`
    ...
    `}_googleSearchBtnsTemplate(){return o` <div class="google-search-btns">
      <input
        type="submit"
...
`,F=()=>{const i=new URL("../src/wa-combobox/assets/obama.jpeg",import.meta.url).href,e=new URL("../src/wa-combobox/assets/trump.jpeg",import.meta.url).href,t=new URL("../src/wa-combobox/assets/biden.jpeg",import.meta.url).href,r=new URL("../src/wa-combobox/assets/bush.jpeg",import.meta.url).href,m=new URL("../src/wa-combobox/assets/clinton.jpeg",import.meta.url).href;return o`
  ...
  `,N=document,R=[{key:"MaterialDesign",story:U},{key:"Github",story:O},{key:"Whatsapp",story:F},{key:"GoogleSearch",story:G}];let u=!1;for(const i of R){const e=N.querySelector(`[mdjs-story-name="${i.key}"]`);e&&(e.story=i.story,e.key=i.key,u=!0,Object.assign(e,{simulatorUrl:"/lion/next/simulator/",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}u&&(customElements.get("mdjs-preview")||c(()=>import("./define.DYUong5B.js"),__vite__mapDeps([0,1,2,3,4,5])),customElements.get("mdjs-story")||c(()=>import("./define.m2CvvXyF.js"),__vite__mapDeps([6,2,3])));export{O as Github,G as GoogleSearch,U as MaterialDesign,F as Whatsapp};
