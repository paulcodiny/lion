import{i as a,a as n}from"./lit-element.qDHKJJma.js";import{x as r}from"./lit-html.C7L4dwLU.js";import{e as o,n as s}from"./ref.DN9F-cVD.js";import{O as l}from"./OverlayMixin.Clz3oycz.js";import"./applyDemoOverlayStyles.Bk3OauXy.js";class i extends l(a){static get properties(){return{simulateViewport:{type:Boolean,attribute:"simulate-viewport",reflect:!0},noDialogEl:{type:Boolean,attribute:"no-dialog-el"},useAbsolute:{type:Boolean,attribute:"use-absolute",reflect:!0}}}static get styles(){return[super.styles||[],n`
    ...
    `};render(){const t=this.constructor;return(this.templates||t.templates).main(this._templateData)}}customElements.define("demo-overlay-el",i);class c extends a{static properties={placementMode:{attribute:"placement-mode",type:String},simulateViewport:{type:Boolean,attribute:"simulate-viewport",reflect:!0},_activePos:{type:String,reflect:!0,attribute:"active-pos"},_activeConfig:{type:Object,state:!0}};static get styles(){return[n`
      ...
      `]}refs={overlay:o()};constructor(){super(),this.placementMode="local",this._placements=[],this.simulateViewport=!1,this._activePos="top"}async _updatePos({pos:t}){this._activePos=t;const e=this.refs.overlay.value;e?._overlayCtrl&&(e.config={popperConfig:{placement:t},viewportConfig:{placement:t}},await e._overlayCtrl.hide(),e._overlayCtrl.show(),e.config={popperConfig:{placement:t},viewportConfig:{placement:t}})}firstUpdated(t){super.firstUpdated(t),this._updatePos({pos:this.placementMode==="local"?"top":"center"})}update(t){t.has("placementMode")&&(this.placementMode==="local"?this._placements=["top-start","top","top-end","right-start","right","right-end","bottom-start","bottom","bottom-end","left-start","left","left-end"]:this._placements=["center","top-left","top","top-right","right","bottom-right","bottom","bottom-left","left"]),super.update(t)}updated(t){super.updated(t),t.has("placementMode")&&(this._activeConfig={placementMode:this.placementMode})}_isActivePosBtn({pos:t}){return t===this._activePos}render(){return r`
      <div class="pos-container pos-container--${this.placementMode}">
        ${this._placements.map(t=>r`
    ...
    `}}customElements.define("demo-overlay-positioning",c);
