...
import{_ as n}from"./preload-helper.nLWefGx3.js";import"./node-tools_providence-analytics_overview.LFFQBZzG.js";import{i as r}from"./lit-element.qDHKJJma.js";import{x as t}from"./lit-html.C7L4dwLU.js";import"./unsafe-html.J0GGe2Q7.js";import"./lion-select-rich.Bx8FhDdQ.js";import"./lion-option.CJQHPQZS.js";import"./directive.CGE4aKEl.js";import"./OverlayMixin.Clz3oycz.js";import"./index.BNCfcFQh.js";import"./lazifyInstantiation.CgYLRMC3.js";import"./dedupeMixin.6XPTJgK8.js";import"./withDropdownConfig.eRP55go6.js";import"./withClickInteraction.B1DPetIk.js";import"./InteractionStateMixin.C2Xjq1f8.js";import"./LocalizeMixin.VYu75dkK.js";import"./directive-helpers.CLllgGgm.js";import"./async-directive.CHVe8p0E.js";import"./getLocalizeManager.W5d_ICRU.js";import"./DisabledMixin.Bm1nsErI.js";import"./LionButton.B9nVXwmc.js";import"./DisabledWithTabIndexMixin.DiSGvuwH.js";import"./LionOption.BBDF9KmV.js";import"./ChoiceGroupMixin.D4jczhm9.js";import"./FormRegistrarMixin.DBLbGJl3.js";import"./ChoiceInputMixin.CLlllJmN.js";const p=()=>t`<lion-select-rich label="Favorite color" name="color">
...
`,k=()=>t`<lion-select-rich name="favoriteColor" label="Favorite color" has-no-default-selected>
  ...
  <lion-option .choiceValue="${"red"}">Red</lion-option>
    ...
    `}addOption(){this.options.push(`Option ${this.options.length+1} with a long title`),this.options=[...this.options],this.requestUpdate()}removeOption(){this.options.length>=2&&(this.options.pop(),this.options=[...this.options],this.requestUpdate())}}customElements.define("single-option-remove-add",b);const V=()=>t`<single-option-remove-add></single-option-remove-add>`,g=document,v=[{key:"HtmlStory34",story:p},{key:"manyOptionsWithScrolling",story:a},{key:"HtmlStory35",story:s},{key:"HtmlStory36",story:d},{key:"HtmlStory37",story:h},{key:"renderOptions",story:m},{key:"HtmlStory38",story:u},{key:"checkedIndexAndValue",story:y},{key:"HtmlStory39",story:k},{key:"HtmlStory40",story:$},{key:"singleOptionRemoveAdd",story:V}];let c=!1;for(const o of v){const e=g.querySelector(`[mdjs-story-name="${o.key}"]`);e&&(e.story=o.story,e.key=o.key,c=!0,Object.assign(e,{simulatorUrl:"/lion/next/simulator/",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}c&&(customElements.get("mdjs-preview")||n(()=>import("./define.DYUong5B.js"),__vite__mapDeps([0,1,2,3,4,5])),customElements.get("mdjs-story")||n(()=>import("./define.m2CvvXyF.js"),__vite__mapDeps([6,2,3])));export{p as HtmlStory34,s as HtmlStory35,d as HtmlStory36,h as HtmlStory37,u as HtmlStory38,k as HtmlStory39,$ as HtmlStory40,y as checkedIndexAndValue,a as manyOptionsWithScrolling,m as renderOptions,V as singleOptionRemoveAdd};
